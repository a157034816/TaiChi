...
impl ServiceRegistrationRequest {
    ...
    pub fn to_json(&self) -> JsonValue {
        ...
        obj.insert("localIp".to_string(), JsonValue::String(self.local_ip.clone()));
        obj.insert("operatorIp".to_string(), JsonValue::String(self.operator_ip.clone()));
        obj.insert("publicIp".to_string(), JsonValue::String(self.public_ip.clone()));
